...
&= \alpha^{-1-\frac{m}{2}} \sum_{t=0}^{m-u} \sum_{u=0}^{m+1} (-\alpha -1)^u \beta_{m+1-u-t} \gamma_{1+t} \sum_{n=0}^m \binom{m-n}{m-u-t}  \binom{n}{t}
\end{align*}
...
\begin{align*}
\sum_{n=0}^m R_{m-n} R_n 
&= \alpha^{-1-\frac{m}{2}} \sum_{t=0}^{m-u} \sum_{u=0}^{m+1} (-\alpha -1)^u \beta_{m+1-u-t} \gamma_{1+t} \binom{m+1}{u} \\
