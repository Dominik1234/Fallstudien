...
\begin{equation*}
	\begin{split}
		...
		&= N^l \sum_{j_1,...,j_l = 1}^N \EE\left[\prod_{p = 1}^l \frac{1}{N} \sum_{k = 1}^N Y_N(j_p,k) \cdot Y_N(j_{p+1},k) \right] \\
		&= \EE \left[\left(\sum_{k = 1}^M Y_N(j_1,k) \cdot Y_N(j_2,k)\right) \cdot \left(\prod_{p = 2}^l \sum_{k = 1}^N Y_N(j_p,k) \cdot Y_N(j_{p+1},k) \right) \right] \\
		&= \EE\left[	\prod_{p = 2}^l \sum_{k_1,k_2 = 1}^N Y_N(j_1,k_1) \cdot Y_N(j_2,k_1) \cdot Y_N(j_p,k_2) \cdot Y_N(j_{p+1},k_2) \right] \\
		&= ... \\
